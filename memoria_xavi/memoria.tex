...
on:
\begin{itemize}[leftmargin=.5in]
	\item [$p$] és una funció que ens retorn la posició de l'elemtn en el ranking
\end{itemize}
...
\todo{buscar: 'fi de grau'}
\subsubsection{Tècnica de reducció de dimensions}
...
\newpage
\todo{buscar: 'técnica' i 'Però clar' -> 'tanmateix' i 'pk'}
